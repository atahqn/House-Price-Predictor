...
def main():
    ...
    my_rfr = RandomForestRegressor(n_estimators=6, min_samples_split=3, max_depth=12)
    ...
    my_rfr_top_features = RandomForestRegressor(n_estimators=6, min_samples_split=3, max_depth=12)
